...
##            self.title = "“火星”实体关系文本标注软件 V1.0-标注界面      管理员:%s   权限:%s" %("user","123456") 
        ...
        #构造字典，用来显示
        self.zh = ['病名','病症','其它','药名','诊断方案','治疗方案', "取消标注",'包含','治疗','危险因素','辅助诊断','特征','并发','别名','作用','条件','诊断']
        self.en = ['dis','hyp','oth','med','dia','cur',"none", 'Incl','Trea','Risk','Auxi','Char','Conc','Alia','Acti','Cond','Diag']
        self.ti = ["A","B","C","D","E","F","Q","I","T","K","U","M","N","L","J","Y","G"]
